...
// faces-gui-mac-app: sourced from config (Settings -> "Refresh interval") so the
// request rate is adjustable; falls back to the original 2000ms default.
const PAINT_INTERVAL_MS = (CONFIG && CONFIG.paintIntervalMs) || 2000;
